<div class="container-fluid">
    ...
    <div class="alert alert-info">
        Hai <strong><?= $this->session->userdata('nama_lengkap'); ?>!</strong> Selamat datang di halaman dashboard administrasi Aplikasi Pembayaran Listrik Pascabayar.
    </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($penghasilan_bulan_ini ?: 0, 0, ',', '.'); ?></div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($pendapatan_tahun_ini ?: 0, 0, ',', '.'); ?></div>
                        </div>
    ...
    <div class="card shadow">
        <div class="card-header">Tagihan Terbaru</div>
        <div class="card-body">
